    ...
    <div className='container pt-24 mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 gap-5'>
            ...
            <ServiceCards 
                icon={icon2} 
                title="Import-Export" 
                subtitles={["En tant qu'acteurs clés dans le commerce international, nous facilitons les opérations d'importation et d'exportation. Nous gérons les aspects logistiques, douaniers et réglementaires pour garantir une chaîne d'approvisionnement fluide et conforme."]}
                internalLink='/services/importexport' 
            />
            <ServiceCards 
                icon={icon3} 
                title="Service Contentieux" 
                subtitles={["Nous offrons un service spécialisé en contentieux immobilier pour résoudre tous les litiges liés à l'achat de terrains ou d'autres biens immobiliers. Que ce soit pour des conflits liés à des transactions, des droits de propriété ou d'autres questions juridiques complexes, notre équipe de professionnels expérimentés est prête à défendre vos intérêts et à trouver des solutions efficaces."]}
            ...
            <ServiceCards 
                ...
                subtitles={["En tant que représentants commerciaux, nous facilitons la mise en relation entre producteurs et clients. Nous développons des stratégies de vente efficaces et utilisons notre connaissance du marché pour optimiser les opportunités commerciales et maximiser les résultats pour nos partenaires."]}
